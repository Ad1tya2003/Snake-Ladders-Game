...
void introduction()
{
 ...
 JLabel l2=new JLabel("<html><body><Font color='red' Size='14'> Hi,</Font><Font color='green' Size='4'>every one this is Snake and Ladders version 1.0 , plz mail if u find any type of problem/error and ur sugession.<br></Font> <Font color='red' Size='3'>thank you<br>visit for more Programs:</Font>  <Font color='gray' Size='6'>gauravsiwach.blogspot.com</Font> </body></html>");
